<?php get_header(); ?>
<?php
	$coverUrl = get_cover_image($cat);
	if (!$coverUrl || $coverUrl == '') {
		$coverUrl = get_cover_homepage();
	}
?>
<div class="row headercover--cat text-center" style="background-image: url('<?php echo $coverUrl; ?>');">
	<h1 class="title font-theme"><?php echo get_cat_name($cat); ?></h1>
</div>
<article class="row">
